...
Public Class Konsumen
    ...
    Private Sub Konsumen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        komandambil.CommandText = "SELECT * FROM Konsumen"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cmdTambah.CommandText = "INSERT INTO " + "Konsumen ([Kode Konsumen], [Nama Konsumen], Umur, [No Telepon], Alamat)" +
            "VALUES ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + " Tahun','" +
        ...
        If tanya = vbYes Then
            ...
            x("Kode Konsumen") = TextBox1.Text
            x("Nama Konsumen") = TextBox2.Text
            x("Umur") = TextBox3.Text + " Tahun"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If x = vbYes Then
            cmdUpdate.CommandText = "UPDATE Konsumen SET " +
                "[Nama Konsumen] = '" + TextBox2.Text + "', " +
                "[Umur] = '" + TextBox3.Text + "', " +
                "[No Telepon] = '" + TextBox4.Text + "', " +
                "Alamat = '" + TextBox5.Text + "' " +
                "WHERE [Kode Konsumen] = '" + TextBox1.Text + "'"
            cmdUpdate.ExecuteNonQuery()

            Dim rowToUpdate As DataRow = datatabelku.Select("[Kode Konsumen] = '" + TextBox1.Text + "'").FirstOrDefault()
            If rowToUpdate IsNot Nothing Then
                rowToUpdate("Kode Konsumen") = TextBox1.Text
                rowToUpdate("Nama Konsumen") = TextBox2.Text
                rowToUpdate("Umur") = TextBox3.Text
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If x = vbYes Then
            cmdHapus.CommandText = "DELETE FROM " + "Konsumen WHERE [Kode Konsumen]= '" + TextBox1.Text + "'"
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        komandambil.Connection = _koneksi
        komandambil.CommandType = CommandType.Text
        komandambil.CommandText = "SELECT * FROM Konsumen WHERE [Kode Konsumen] LIKE '%" + TextBox6.Text + "%' " +
                                       "OR [Nama Konsumen] LIKE '%" + TextBox6.Text + "%' " +
                                       "OR [Umur] LIKE '%" + TextBox6.Text + "%' " +
